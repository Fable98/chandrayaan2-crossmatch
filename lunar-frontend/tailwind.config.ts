    ...
    extend: {
      colors: {
        ...
        retro: {
          ...
          "panel-light": "var(--retro-panel-light)",
          "surface-light": "var(--retro-surface-light)",
          "surface-dark": "var(--retro-surface-dark)",
          teal: "#1F4743",
          "teal-dark": "#143532",
          "teal-light": "#2A5D57",
          blue: "#28557E",
          ...
          "border-gray": "var(--retro-border-gray)",
          "border-dark": "var(--retro-border-dark)",
        },
      },
      fontFamily: {
        sans: ["var(--font-inter)", "var(--font-plex-sans)", "system-ui", "-apple-system", "sans-serif"],
