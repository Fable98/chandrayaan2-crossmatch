...
export default function DossierModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="relative flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-lg border border-[#1f326e] bg-[#091540] text-white shadow-xl">
        {/* Header Bar */}
        <div className="flex items-center justify-between border-b border-[#1f326e] bg-[#12235c] px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="rounded bg-[#091540] px-2 py-0.5 text-xs text-[#ABD2FA]">
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
          {/* Top Metadata Block */}
          <div className="flex flex-col justify-between gap-4 border-b border-[#1f326e] pb-6 sm:flex-row sm:items-baseline">
            <div>
              <span className="text-xs font-medium uppercase tracking-wider text-[#7692FF]">
                Coordinates
              </span>
            ...
            <div className="text-xs text-[#ABD2FA]">
          ...
          <div>
            <span className="mb-3 block text-xs font-medium text-[#ABD2FA]">
              Sensor Imagery (OHRC · TMC-2 · IIRS)
            </span>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {/* OHRC */}
              <div className="flex flex-col gap-2 rounded-md border border-[#1f326e] bg-[#12235c] p-3">
                ...
                <div className="text-xs">
                  ...
                  <p className="text-[11px] text-[#7692FF]">0.25–0.32 m/px</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 rounded-md border border-[#1f326e] bg-[#12235c] p-3">
                ...
                <div className="text-xs">
                  ...
                  <p className="text-[11px] text-[#7692FF]">~4–5 m/px stereo</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 rounded-md border border-[#1f326e] bg-[#12235c] p-3">
                ...
                <div className="text-xs">
                  ...
                  <p className="text-[11px] text-[#7692FF]">~70–80 m/px</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2 rounded-md border border-[#1f326e] bg-[#12235c] p-3">
                ...
                <div className="text-xs">
                  <span className="text-[#7692FF] font-medium">50% Blend Overlay</span>
                  <p className="text-[11px] text-[#7692FF]">Homography transformed</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 border-t border-[#1f326e] pt-6 sm:grid-cols-2">
            <div>
              <h4 className="text-xs font-semibold uppercase tracking-wider text-[#ABD2FA]">
                Registration Telemetry
              </h4>
              <div className="mt-3 space-y-2 text-xs text-[#ABD2FA]">
                <div className="flex justify-between border-b border-[#1f326e] pb-1.5">
                ...
                <div className="flex justify-between border-b border-[#1f326e] pb-1.5">
                  ...
                  <span className="font-medium text-[#7692FF]">
            ...
            <div>
              ...
              <p className="mt-3 text-xs leading-relaxed text-[#ABD2FA]">
        ...
        {/* Footer Actions */}
        <div className="flex items-center justify-between border-t border-[#1f326e] bg-[#12235c] px-6 py-4">
          <button
            onClick={onClose}
            className="rounded-md border border-[#1f326e] bg-[#091540] px-4 py-2 text-xs text-[#ABD2FA] transition-colors hover:bg-[#1f326e] hover:text-white"
          >
            Close
          </button>
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-md bg-[#1B2CC1] px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#2539db]"
          >
